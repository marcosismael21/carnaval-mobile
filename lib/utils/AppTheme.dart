...
class AppThemeData {
  ...
  static final ThemeData lightTheme = ThemeData(
    ...
    appBarTheme: AppBarTheme(
      ...
      systemOverlayStyle: SystemUiOverlayStyle(statusBarIconBrightness: Brightness.dark, statusBarColor: rf_primaryColor),
    ),
  ...
  static final ThemeData darkTheme = ThemeData(
    ...
    appBarTheme: AppBarTheme(
      ...
      systemOverlayStyle: SystemUiOverlayStyle(statusBarIconBrightness: Brightness.light, statusBarColor: rf_primaryColor),
    ),
